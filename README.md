...
To upgrade Specify, see the [Upgrading Spec Kit guide](./docs/upgrading-spec-kit.md) or the [Upgrade Guide](./docs/upgrade.md) for detailed instructions. Quick upgrade:
